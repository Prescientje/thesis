...
today = date.today()
file_s = "logs/" + today.strftime("%y%m%d") + "-layered5-fc-%s.txt" % test_num
...
print_write("Layered-LR-MODELBUILDER 5 fully connected TEST")
...
lxyz_place = tf.placeholder(tf.float32, [None,3*sample_len])
rxyz_place = tf.placeholder(tf.float32, [None,3*sample_len])

wbl1, bbl1, layerbl1 = makeLayer(lxyz_place,3*sample_len,512,"relu", "wbl1", "bbl1")
wbr1, bbr1, layerbr1 = makeLayer(rxyz_place,3*sample_len,512,"relu", "wbr1", "bbr1")
wbl2, bbl2, layerbl2 = makeLayer(layerbl1,512,512,"relu", "wbl2", "bbl2")
wbr2, bbr2, layerbr2 = makeLayer(layerbr1,512,512,"relu", "wbr2", "bbr2")
wbl3, bbl3, layerbl3 = makeLayer(layerbl2,512,512,"relu", "wbl3", "bbl3")
wbr3, bbr3, layerbr3 = makeLayer(layerbr2,512,512,"relu", "wbr3", "bbr3")
wbl4, bbl4, layerbl4 = makeLayer(layerbl3,512,512,"relu", "wbl4", "bbl4")
wbr4, bbr4, layerbr4 = makeLayer(layerbr3,512,512,"relu", "wbr4", "bbr4")
wbl5, layerbl5 = makeLayer(layerbl4,512,2,None,"wbl5", "bbl5")
wbr5, layerbr5 = makeLayer(layerbr4,512,2,None,"wbr5", "bbr5")
...
bL2 = tf.nn.l2_loss(wbl1) + tf.nn.l2_loss(wbr1) + tf.nn.l2_loss(wbl2) + tf.nn.l2_loss(wbr2) + tf.nn.l2_loss(wbl3) + tf.nn.l2_loss(wbr3) + \
      tf.nn.l2_loss(wbl4) + tf.nn.l2_loss(wbr4) + tf.nn.l2_loss(wbl5) + tf.nn.l2_loss(wbr5)
